 ...
 */
public class MePhotosFragment extends Fragment {

    private static final String TAG = MePhotosFragment.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_me_photos, container, false);
