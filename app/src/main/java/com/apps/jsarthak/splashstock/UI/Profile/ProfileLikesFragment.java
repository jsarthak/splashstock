...
public class ProfileLikesFragment extends Fragment {
    ...
    private static final String TAG = ProfileLikesFragment.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView= inflater.inflate(R.layout.fragment_profile_likes, container, false);
    ...
    void loadMore(int page, String username) {
        ...
        builder.scheme("https")
                ...
                .appendPath("users").appendPath(username).appendPath("likes")
